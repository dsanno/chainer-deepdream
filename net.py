...
class GoogleNet(CaffeNet):
    ...
    def __call__(self, x, outputs=['loss3/classifier'], train=True):
#        return self.func(inputs={'data': x}, outputs=outputs, disable=['loss1/ave_pool', 'loss2/ave_pool'], train=False)
        return super(GoogleNet, self).__call__(inputs={'data': x}, outputs=outputs, disable=['loss1/ave_pool', 'loss2/ave_pool', 'inception_4d/1x1', 'inception_4d/3x3_reduce', 'inception_4d/5x5_reduce', 'inception_4d/pool'], train=train)
